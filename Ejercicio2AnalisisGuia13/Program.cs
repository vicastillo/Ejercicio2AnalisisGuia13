...
namespace Ejercicio2AnalisisGuia13
{
class Program
{
struct ejemplo
...
for (int i = 0; i < tan; i++)
{
archivo.WriteLine("Placa: " + E[i].Placa);
archivo.WriteLine("Color: " + E[i].Color);
archivo.WriteLine("Año: " + E[i].Año);
archivo.WriteLine("Marca: " + E[i].Marca);
archivo.WriteLine("Modelo: " + E[i].Modelo);
archivo.WriteLine("----------------------");
}
archivo.WriteLine();
archivo.Close();
